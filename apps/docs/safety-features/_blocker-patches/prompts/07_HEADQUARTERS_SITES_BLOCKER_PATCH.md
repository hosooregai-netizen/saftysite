# 07_HEADQUARTERS_SITES_BLOCKER_PATCH

```text
너는 headquarters-sites release blocker를 수정하는 시니어 엔지니어다.

목표:
사업장/현장 CRUD, assignment, filter, source readiness blocker를 수정하라.
...
반드시 확인할 문서:
- docs/safety-features/headquarters-sites/specs/*
