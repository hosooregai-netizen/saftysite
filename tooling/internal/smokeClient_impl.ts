    ...
    headquarters: [
      {
        id: 'hq-1',
        name: '기존 본사',
        management_number: 'HQ-001',
        opening_number: 'OPEN-001',
        ...
        memo: '본사 대표 연락처와 등록번호를 운영 기준으로 유지합니다.',
        is_active: true,
        created_at: NOW,
        updated_at: NOW,
      },
    ...
    sites: [
      {
        ...
        labor_office: '서울지방고용노동청',
        guidance_officer_name: '김요원',
        project_start_date: '2026-01-01',
        project_end_date: '2026-06-30',
        project_amount: 100000000,
        project_scale: '지하 1층, 지상 8층',
        project_kind: '근린생활시설 신축',
        client_management_number: 'CLIENT-001',
        client_business_name: '테스트발주처',
        client_representative_name: '최대표',
        client_corporate_registration_no: '220111-7654321',
        client_business_registration_no: '987-65-43210',
        order_type_division: '민간',
        technical_guidance_kind: '정기 기술지도',
        manager_name: '박소장',
        manager_phone: '010-3333-3333',
        contract_contact_name: '정계약',
        inspector_name: '이점검',
        ...
        status: 'active',
        memo: '20억 이상 현장으로 발송 기준 주소와 계약 상태를 우선 관리합니다.',
        created_at: NOW,
        updated_at: NOW,
      },
    ],
  ...
  const handleAdminSafetyRoute = async (route) => {
    ...
    if (pathname === '/sites' && request.method() === 'POST') {
      ...
      const created = {
        ...
        lifecycle_status: body.lifecycle_status ?? body.status ?? 'planned',
