...
export const ADMIN_FEATURE_CONTRACTS = {
  'admin-control-center': {
    ...
    criticalActions: ['admin 로그인 진입', 'overview 진입', 'analytics 진입', 'overview-first 초기 로딩 상태 유지', 'session cache 재진입 확인', '기간 전환', '차트 연도 탭 전환', 'analytics 계약유형 lookup 확인', 'site 계약 수정 반영 확인', 'K2B 회차 실적 집계 확인', '실행/남은 회차 KPI 확인', 'legacy 무일정 데이터 백필 확인', '엑셀 내보내기', '핵심 카드와 차트 확인'],
  },
  'admin-headquarters': {
