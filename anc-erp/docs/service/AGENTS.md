...
- `docs/service/docs/aec-erp/00-overall/01_FUNCTION_INDEX.md`
- `docs/service/docs/aec-erp/00-overall/02_GLOBAL_DESIGN_SYSTEM.md`
- `docs/service/docs/aec-erp/00-overall/04_DOCUMENT_PACK_RULE.md`
- `docs/service/docs/aec-erp/00-overall/05_MODULE_CONTAINMENT_MAP.md`
- `docs/service/docs/aec-erp/00-overall/10_GLOBAL_REVERSE_MAP.md`
- The target feature folder under `docs/service/docs/aec-erp/{feature-folder}/`
...
For parity-sensitive modules, use the existing product as a porting baseline:

- `apps/web/app/webhard` and `apps/web/features/drive/*` for Webhard information architecture and full-screen host UX
- `apps/web/app/mailbox` and `apps/web/features/mailbox/*` for Mailbox 3-pane UX and account/message flows
- `apps/web/app/dashboard`, project/report hub surfaces, and shared shells for higher-level ERP navigation patterns

Parity means matching route intent, shell structure, navigation model, and core user workflows while preserving the new ERP containment model. Do not blindly clone route names or legacy domain ownership rules when the A&C ERP docs intentionally changed them.
