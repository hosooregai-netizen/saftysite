...
import { buildStandardInspectionHwpxDocument } from '@/server/documents/inspection/standardHwpx';
  ...
  try {
    ...
    const generated =
      payload.kind === 'document'
        ? await buildStandardInspectionHwpxDocument(payload.session, payload.siteSessions, {
