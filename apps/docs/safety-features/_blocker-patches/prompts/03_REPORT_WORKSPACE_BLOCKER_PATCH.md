# 03_REPORT_WORKSPACE_BLOCKER_PATCH

```text
너는 report-workspace release blocker를 수정하는 시니어 엔지니어다.

목표:
보고서 생성, AI 초안, review/export gate blocker를 수정하라.
...
반드시 확인할 문서:
- docs/safety-features/report-workspace/specs/*
