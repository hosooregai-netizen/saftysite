# 02_BILLING_CREDITS_BLOCKER_PATCH

```text
너는 billing-credits release blocker를 수정하는 시니어 엔지니어다.

목표:
Toss confirm/webhook, credit ledger, report export billing blocker를 수정하라.
...
반드시 확인할 문서:
- docs/safety-features/billing-credits/specs/*
