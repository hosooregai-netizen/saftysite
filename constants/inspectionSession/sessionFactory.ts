...
function createTechnicalGuidanceOverview(
  ...
  return {
    ...
    accidentPhotoUrl: '',
    accidentPhotoUrl2: '',
    accidentOccurrencePart: '',
    accidentImplementationStatus: '',
    processWorkerCount: '',
    processEquipment: '',
    processTools: '',
...
export function createInspectionSession(
  ...
  return finalizeInspectionSession({
    ...
    scheduleRoundNo: options.scheduleRoundNo ?? null,
    reportNumber,
    currentSection: 'doc1',
    meta,
    ...
    document12Activities: Array.from({ length: DOC12_ACTIVITY_GRID_SLOTS }, () => createActivityRecord()),
