# 06_PHOTO_ALBUM_BLOCKER_PATCH

```text
너는 photo-album release blocker를 수정하는 시니어 엔지니어다.

목표:
사진첩 grid/filter/guest adapter/evidence linking blocker를 수정하라.
...
반드시 확인할 문서:
- docs/safety-features/photo-album/specs/*
