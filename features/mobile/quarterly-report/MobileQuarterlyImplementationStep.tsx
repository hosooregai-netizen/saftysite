      ...
      {draft.implementationRows.length > 0 ? (
        <div className={styles.mobileImplementationList}>
          {draft.implementationRows.map((row, index) => {
            const isLastRow = index === draft.implementationRows.length - 1;
            ...
            return (
              <article key={row.sessionId} className={styles.mobileImplementationItem}>
                ...
                <label
                  className={`${styles.mobileEditorFieldGroup} ${styles.mobileImplementationFieldWide}`}
                >
                  ...
                  <input
                    ...
                    placeholder="보고서명"
                    onChange={(event) =>
                      onUpdateRow(row.sessionId, 'reportTitle', event.target.value)
                    }
                  />
                </label>
                <div className={styles.mobileImplementationFieldGrid}>
                  <label className={styles.mobileEditorFieldGroup}>
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        onUpdateRow(row.sessionId, 'reportNumber', event.target.value)
                      }
                    />
                  </label>
                  <label className={styles.mobileEditorFieldGroup}>
                    ...
                    <input
                      ...
                      placeholder="담당자"
                      onChange={(event) =>
                        onUpdateRow(row.sessionId, 'drafter', event.target.value)
                      }
                    />
                  </label>
                  <label className={styles.mobileEditorFieldGroup}>
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        onUpdateRow(row.sessionId, 'reportDate', event.target.value)
                      }
                    />
                  </label>
                  <label className={styles.mobileEditorFieldGroup}>
                    ...
                    <input
                      ...
                      placeholder="공정률"
                      onChange={(event) =>
                        onUpdateRow(row.sessionId, 'progressRate', event.target.value)
                      }
                    />
                  </label>
                  <label className={styles.mobileEditorFieldGroup}>
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        onUpdateRow(row.sessionId, 'findingCount', event.target.value)
                      }
                    />
                  </label>
                  <label className={styles.mobileEditorFieldGroup}>
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        onUpdateRow(row.sessionId, 'improvedCount', event.target.value)
                      }
                    />
                  </label>
                  <label
                  ...
                  >
                    ...
                    <input
                      ...
                      placeholder="비고"
                      onChange={(event) =>
                        onUpdateRow(row.sessionId, 'note', event.target.value)
                      }
                    />
                  </label>
                </div>
