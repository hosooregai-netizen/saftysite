...
export function Doc7FindingPhotoPanel({
  ...
  const photoSlotHeight = 256;
  const photoColumnStyle: CSSProperties = {
    ['--doc7-photo-slot-height' as string]: `${photoSlotHeight}px`,
  };

  return (
    <div className={styles.doc7PhotoColumn} style={photoColumnStyle}>
      <div className={styles.doc7PhotoTableWrap}>
        <div className={styles.doc7PhotoStack}>
          <section className={styles.doc7PhotoSlot}>
            <div className={styles.doc7PhotoLabelCell}>
            ...
            <div className={styles.doc7PhotoValueCell}>
              <UploadBox
                id={`finding-photo-1-${item.id}`}
                label="현장 사진 1"
                labelLayout="field"
                fieldBodyHeight={photoSlotHeight}
                fieldClearOverlay
                fieldLabelMode="omit"
                fitImageToBox
                value={item.photoUrl}
          ...
          <section className={styles.doc7PhotoSlot}>
            <div className={styles.doc7PhotoLabelCell}>현장 사진 2</div>
            <div className={styles.doc7PhotoValueCell}>
              <UploadBox
