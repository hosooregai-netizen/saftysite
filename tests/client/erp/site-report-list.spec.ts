...
export async function runSiteReportListSmoke(config: ClientSmokePlaywrightConfig) {
  ...
  try {
    ...
    await createDialog.getByLabel('제목').fill('테스트 보고서 목록 자동화');
