...
const FULL_SMOKE_SCOPE_RULES = [
  ...
  { pattern: /^tests\/client\/contracts\/smoke-specs\/admin\/.*\.md$/, scopes: [ADMIN_SCOPE] },
  { pattern: /^tests\/client\/contracts\/smoke-specs\/erp\/.*\.md$/, scopes: [ERP_SCOPE] },
  { pattern: /^tests\/client\/contracts\/shared\.ts$/, scopes: BOTH_SCOPES },
  { pattern: /^tests\/client\/featureContracts\.ts$/, scopes: BOTH_SCOPES },
  { pattern: /^tests\/client\/smokeRegistry\.generated\.ts$/, scopes: BOTH_SCOPES },
  ...
  { pattern: /^scripts\/generateSmokeRegistry\.mjs$/, scopes: BOTH_SCOPES },
  { pattern: /^scripts\/listSmokeRegistryContractIds\.ts$/, scopes: BOTH_SCOPES },
  { pattern: /^scripts\/smokeClient\.ts$/, scopes: [ERP_SCOPE] },
  { pattern: /^scripts\/smokeRegistrySupport\.mjs$/, scopes: BOTH_SCOPES },
