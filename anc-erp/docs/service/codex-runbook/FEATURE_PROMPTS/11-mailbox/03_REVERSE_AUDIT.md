...
- Existing `apps/web` mailbox host UX as a parity baseline
...
10. Does the resulting shell and flow preserve parity with the existing `apps/web` 3-pane mailbox experience while keeping ERP linkage visible?
