# 09_DOCS_REGISTRY_BLOCKER_PATCH

```text
너는 docs-registry release blocker를 수정하는 시니어 엔지니어다.

목표:
문서 registry, reverse map, docs coverage blocker를 수정하라.
...
반드시 확인할 문서:
- docs/safety-features/docs-registry/specs/*
