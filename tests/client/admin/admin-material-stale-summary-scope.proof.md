...
- Reproduced the same stale summary at the Next admin overview API mapper layer and verified it is normalized to the mapped priority quarterly scope before reaching the UI.
