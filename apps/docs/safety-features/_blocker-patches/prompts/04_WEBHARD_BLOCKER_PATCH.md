# 04_WEBHARD_BLOCKER_PATCH

```text
너는 webhard release blocker를 수정하는 시니어 엔지니어다.

목표:
웹하드 권한, public share, Drive-like visual regression blocker를 수정하라.
...
반드시 확인할 문서:
- docs/safety-features/webhard/specs/*
